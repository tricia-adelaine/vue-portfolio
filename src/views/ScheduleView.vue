    ...
    <nav class="navbar">
      <div class="navbar-container">
        ...
        <div class="navigation">
          ...
          <strong
            ><router-link class="sched" to="/sched"
              >Watering Schedule</router-link
            ></strong
          >
        </div>
      ...
      <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="input-row">
              <input type="time" v-model="schedule3" class="time-input" />
              <input type="date" v-model="selectedDate" class="date-input" />
            </div>
            <div class="input-row">
              <input type="time" v-model="schedule4" class="time-input" />
              <input type="date" v-model="selectedDate" class="date-input" />
            </div>
          </div>
          <button @click="addScheduleTime" class="add-time-button">
            Add Schedule
          </button>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      methods: {
        addScheduleTime() {
          this.scheduleTimes.push(""); // Add a new empty time input
        },
      },
    };
  },
